...
public final class Converter {
  ...
  /**
   * to Conversion music to ByteArrayOutputStream.
   */
  ...
  /**
   * Function toByteArray to produce byte[] from a music.
   *
   */
  ...
  /**
   * Function to conver inputStream with targetformat to OutputStream.
   * @param input InputStream
   * @param output OutputStream
   * @param targetFormat targetFormat
   * @throws Exception Error
   */
  private void convert(InputStream input,
                       OutputStream output,
    ...
    try (
      ...
      try (
          ...
          final AudioInputStream convertStream =
  ...
  /**
   *  Function to get basic AudioFormat.
